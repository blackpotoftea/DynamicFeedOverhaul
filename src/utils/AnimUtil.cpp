...
namespace AnimUtil {
    ...
    static const char* GetConditionFunctionName(int funcID) {
        switch (funcID) {
    ...
    void DebugFindKillMove(RE::Actor* player, RE::Actor* target) {
        ...
        SKSE::log::info("  - AngleToTarget: {:.2f} rad ({:.1f} deg)",
            context.angleToTarget, toDegrees(context.angleToTarget));
